  ...
  @override Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: colors.surface, appBar: AppBar(title: Text(l.settings), backgroundColor: colors.surface, elevation: 0), body: SingleChildScrollView(padding: const EdgeInsets.all(16), child: Column(children: [
      ...
      sectionCard(context, child: Column(children: [
        ...
        const SizedBox(height: 12), DropdownButtonFormField<String>(initialValue: currency, decoration: themedInput(context, l.currency, Icons.payments), items: const [DropdownMenuItem(value: 'PKR', child: Text('PKR'))], onChanged: (value) { if (value != null) setState(() => currency = value); }),
