  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(padding: const EdgeInsets.all(12), child: Column(children: [
        ...
        field(DropdownButtonFormField<String>(value: selectedRateType, decoration: fieldDecoration(l10n.rateType, Icons.category), items: rateTypes.map((e) => DropdownMenuItem(value: e, child: Text(localizedRateType(e)))).toList(), onChanged: (value) { if (value != null) setState(() => selectedRateType = value); })),
