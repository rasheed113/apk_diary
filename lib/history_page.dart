...
class _HistoryPageState extends State<HistoryPage> {
              ...
              children: [
                ...
                Expanded(child: ListView.builder(
                  ...
                  itemBuilder: (c, i) {
                    final w = weeks[i];
                    return ListTile(
                      leading: icon3D(context, Icons.calendar_view_week, size: 20),
                      title: Text(i == 0 ? l.thisWeek : '$i ${l.week}', style: TextStyle(fontWeight: FontWeight.w700, color: s.onSurface)),
                      subtitle: Text(_weekLabel(w), style: TextStyle(color: s.onSurfaceVariant)),
                      trailing: icon3D(context, Icons.chevron_right, size: 20),
              ...
              children: [
                ...
                Expanded(child: ListView.builder(
                  ...
                  itemBuilder: (c, i) {
                    final m = months[i];
                    return ListTile(
                      leading: icon3D(context, Icons.calendar_month, size: 20),
                      title: Text(i == 0 ? l.thisMonth : '$i ${l.month}', style: TextStyle(fontWeight: FontWeight.w700, color: s.onSurface)),
  ...
  Future<void> confirmDelete(DiaryEntry entry) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (c) => AlertDialog(
        ...
        content: Text('${l.deleteEntryConfirmation}\n\n${entry.itemName}'),
        actions: [
          TextButton(onPressed: () => Navigator.pop(c, false), child: Text(l.cancel)),
          TextButton(onPressed: () => Navigator.pop(c, true), child: Text(l.delete)),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text(l.history), backgroundColor: s.surface, elevation: 0),
        ...
        builder: (context, snapshot) {
          ...
          return Column(
            children: [
              ...
              Padding(padding: const EdgeInsets.fromLTRB(8, 8, 8, 0), child: Row(children: [Expanded(child: OutlinedButton.icon(onPressed: _showWeeklyHistory, icon: icon3D(context, Icons.calendar_view_week, size: 18), label: Text(l.weeklyHistory))), const SizedBox(width: 8), Expanded(child: OutlinedButton.icon(onPressed: _showMonthlyHistory, icon: icon3D(context, Icons.calendar_month, size: 18), label: Text(l.monthlyHistory)))])),
