...
class _DashboardPageState extends State<DashboardPage> {
  ...
  String getTickerMessage() {
    if (totalEarning <= 0) {
      return '✨ Welcome to WorkEarn  •  Turn every stitch into progress  •  Add your first entry';
    }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [Colors.white, s.primary.withValues(alpha: .045)],
        ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: s.primary.withValues(alpha: .14),
                  blurRadius: 10,
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  maxLines: 1,
                  style: TextStyle(
                    color: s.primary.withValues(alpha: .56),
                    fontSize: 9,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(colors: [s.secondary, s.primary]),
                  ),
                ),
              ],
            ),
  ...
  Widget buildGlowButton({required IconData icon, required String label, required VoidCallback onPressed}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: s.primary.withValues(alpha: .07),
            blurRadius: 10,
            offset: const Offset(0, 4),
          ),
        ],
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: [Colors.white, s.primary.withValues(alpha: .035)],
          ),
          border: Border.all(color: s.primary.withValues(alpha: .12)),
          boxShadow: [
            BoxShadow(
              color: s.primary.withValues(alpha: .055),
              blurRadius: 10,
              offset: const Offset(0, 4),
            ),
          ],
