...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l.dashboard, style: const TextStyle(fontWeight: FontWeight.w900)),
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(children: [
              ...
              child: ClipRRect(
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Marquee(
                    text: tickerMessage.isEmpty ? '✨ ${l.welcomeToWorkEarn}  •  ${l.turnEveryStitchIntoProgress}' : tickerMessage,
            ...
            const SizedBox(height: 12),
            Row(children: [
              Expanded(child: buildGlowButton(icon: Icons.add_circle_outline_rounded, label: l.newEntry, onPressed: () async {
                final r = await Navigator.push(context, MaterialPageRoute(builder: (_) => const WorkPage()));
                if (r == true && mounted) await loadDashboard();
              })),
